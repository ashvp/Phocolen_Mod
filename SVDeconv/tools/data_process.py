...
svd_dir = os.path.join(os.path.dirname(tools_dir))
...
source_orig_dir = "/4tb_hdd/Ashwin/lenslessFlatnetEndoNeRF/targets"
...
for cls in tqdm(os.listdir(source_svd_train_dir)):
    ...
    for file in os.listdir(cls_dir):
        if file.endswith('png') and file.startswith('output_'):
            ...
            gt_file = os.path.join(source_orig_dir, file[7:])
